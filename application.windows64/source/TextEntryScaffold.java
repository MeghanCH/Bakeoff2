...
final float sizeOfInputArea = DPIofYourDeviceScreen*1.25f; //aka, 1.25 inches square!
...
public int computeLevenshteinDistance(String phrase1, String phrase2)  
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "TextEntryScaffold" };
    if (passedArgs != null) {
